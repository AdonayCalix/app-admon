...
$list = \app\modules\qb\models\ListClass::find()
    ->where(['like', 'name', 'Egresos'])
...
<div class="list-class-form" id="list-class">
    ...
    <input type="hidden" id="last_id" value="<?= $list->identifier ?>">
    ...
    <div class="form-group row">
        ...
        <label class="col-sm-2 col-form-label" v-on:click="changeDisabled">
            <input type="checkbox" name="ListClass[is_parent]" v-model="checked" value="false" true-value="yes"
                   false-value="no">
            Sub Clase De?
        </label>
        <div class="col-sm-10">
            <treeselect v-model="subClass" :disabled="disabled" name="ListClass[sub_class]" :multiple="false"
                        placeholder="[SELECCIONE]" :options="options"/>
        </div>
    </div>
