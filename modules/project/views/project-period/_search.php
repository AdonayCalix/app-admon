...
/* @var $model app\modules\project\models\ProjectPeriodSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="form-project-period-search">
    ...
    <?php /* echo $form->field($model, 'crated_by')->textInput(['placeholder' => 'Crated By']) */ ?>
